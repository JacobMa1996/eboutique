...
module.exports = {
    ...
    CREATE_USER: `CREATE TABLE IF NOT EXISTS user(
        user_id INT(5) NOT NULL AUTO_INCREMENT DEFAULT=10000,
    ...
    CREATE_CATEGORY: `CREATE TABLE IF NOT EXISTS category(
        cate_id INT(5) NOT NULL AUTO_INCREMENT DEFAULT=10000,
    ...
    CREATE_PRODUCT: `CREATE TABLE IF NOT EXISTS product(
        pro_id INT(5) NOT NULL AUTO_INCREMENT DEFAULT=10000,
    ...
    CREATE_PRODUCTORDER: `CREATE TABLE IF NOT EXISTS productorder(
        order_id INT(5) NOT NULL AUTO_INCREMENT DEFAULT=10000,
    ...
    /* sql 插入数据 */
    INSERT_USER: (data) => `INSERT INTO user(user_name, user_pass, user_phone, user_img, sex, favorites, added, carts) VALUES ('${data.user_name}', '${data.user_pass}', '${data.user_phone}', ${data.sex}, '${data.favorites}', '${data.added}', '${data.carts}');`,
    ...
    INSERT_PRODUCT: (data) => `INSERT INTO product(pro_title, pro_subtitle, pro_detail, pro_img, original_price, current_price, pro_keep, pro_code, review_status) VALUES ('${data.pro_title}', '${data.pro_subtitle}', '${data.pro_detail}', '${data.pro_img}', '${data.original_price}', '${data.current_price}', '${data.pro_keep}', '${data.pro_code}', '${data.review_status}');`,
