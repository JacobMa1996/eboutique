...
// 根据用户ID查询订单
const queryOrderByUserId = (data) => {
    return new Promise((resolve, reject) => {
        query(SQL.QUERY_PRODUCTORDER_BY_USER(data)).then(res => {
            resolve(res)
        }).catch(err => {
            reject(err)
        })
...
// 根据用户ID查询商品
const queryProductByUserId = (data) => {
    return new Promise((resolve, reject) => {
        query(SQL.QUERY_PRODUCT_BY_USER(data)).then(res => {
            resolve(res)
        }).catch(err => {
            reject(err)
        })
...
module.exports = {
    ...
    queryOrderByUserId: queryOrderByUserId,
    queryProductByUserId: queryProductByUserId
}